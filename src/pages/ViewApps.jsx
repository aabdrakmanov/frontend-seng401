                    ...
                    <div className="grid-portfolio">
                        ...
                        <div className="grid-item other" data-aos="fade-up">
                            <div className="grid-item-wrapper">
                                ...
                                <div className="grid-info">
                                    ...
                                    <Link className="ext-link" to = "/devResult?=Uber">
                        ...
                        <div className="grid-item minimalism grid-item-height" data-aos="fade-up">
                            <div className="grid-item-wrapper">
                                ...
                                <div className="grid-info">
                                    <div className="grid-link d-flex justify-content-center">
                                        <Link className="img-pop" to = "/devResult?=Netflix">
                            ...
                            <div className="grid-item-wrapper">
                                ...
                                <div className="grid-info">
                                    <div className="grid-link d-flex justify-content-center">
                                        ...
                                        <Link className="ext-link" to = "/devResult?=Twitch">
                                            <span className="lnr lnr-link"></span>
                                        </Link>
                                    </div>
                                    <div className="grid-title">
                            ...
                            <div className="grid-item-wrapper">
                                ...
                                <div className="grid-info">
                                    <div className="grid-link d-flex justify-content-center">
                                        ...
                                        <Link className="ext-link" to = "/devResult?=Amazon">
                                            <span className="lnr lnr-link"></span>
                                        </Link>
                                    </div>
                                    <div className="grid-title">
                            ...
                            <div className="grid-item-wrapper">
                                ...
                                <div className="grid-info">
                                    <div className="grid-link d-flex justify-content-center">
                                        ...
                                        <Link className="ext-link" to = "/devResult?=Minecraft">
                                            <span className="lnr lnr-link"></span>
                                        </Link>
                                    </div>
                                    <div className="grid-title">
                            ...
                            <div className="grid-item-wrapper">
                                ...
                                <div className="grid-info">
                                    <div className="grid-link d-flex justify-content-center">
                                        ...
                                        <Link className="ext-link" to = "/devResult?=Prime Video" target="_blank">
                                            <span className="lnr lnr-link"></span>
                                        </Link>
                                    </div>
                                    <div className="grid-title">
