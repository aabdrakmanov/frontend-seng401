                    ...
                    <div className="grid-portfolio">
                        ...
                        <div className="grid-item other" data-aos="fade-up">
                            <div className="grid-item-wrapper">
                                ...
                                <div className="grid-info">
                                    ...
                                    <a className="ext-link" href="result" target="_blank">
                        ...
                        <div className="grid-item minimalism grid-item-height" data-aos="fade-up">
                            <div className="grid-item-wrapper">
                                ...
                                <div className="grid-info">
                                    <div className="grid-link d-flex justify-content-center">
                                        <a className="img-pop" data-rel="lightcase" href="https://o.qoo-img.com/ggpht/59Y11UN03Is138F70z_I_ZN_gc8yPNNUAlh5BKlQVl82Bw07FA30sO9LWWO9Cm8PF7o?w=192"title="Tracy Portrait">
                         ...
                         <div className="grid-item minimalism" data-aos="fade-up">
                            <div className="grid-item-wrapper">
                                ...
                                <div className="grid-info">
                                    <div className="grid-link d-flex justify-content-center">
                                        <a className="img-pop" data-rel="lightcase" href="/static/img/twitch.jpg" title="Guitar">
                                            <span className="lnr lnr-move"></span>
                                        </a>
                                        <a className="ext-link" href="https://unsplash.com/" target="_blank">
                                            <span className="lnr lnr-link"></span>
                        ...
                        <div className="grid-item creative" data-aos="fade-up">
                            <div className="grid-item-wrapper">
                                ...
                                <div className="grid-info">
                                    <div className="grid-link d-flex justify-content-center">
                                        <a className="img-pop" data-rel="lightcase" href="/static/img/photo-4.jpg" title="Bookself">
                                            <span className="lnr lnr-move"></span>
                                        </a>
                                        <a className="ext-link" href="https://unsplash.com/" target="_blank">
                                            <span className="lnr lnr-link"></span>
                        ...
                        <div className="grid-item minimalism" data-aos="fade-up">
                            <div className="grid-item-wrapper">
                                ...
                                <div className="grid-info">
                                    <div className="grid-link d-flex justify-content-center">
                                        <a className="img-pop" data-rel="lightcase" href="/static/img/photo-9.jpg" title="Guitar">
                                            <span className="lnr lnr-move"></span>
                                        </a>
                                        <a className="ext-link" href="https://unsplash.com/" target="_blank">
                                            <span className="lnr lnr-link"></span>
                        ...
                        <div className="grid-item other" data-aos="fade-up">
                            <div className="grid-item-wrapper">
                                ...
                                <div className="grid-info">
                                    <div className="grid-link d-flex justify-content-center">
                                        <a className="img-pop" data-rel="lightcase" href="/static/img/minecraft.png" title="Guitar">
                                            <span className="lnr lnr-move"></span>
                                        </a>
                                        <a className="ext-link" href="https://unsplash.com/" target="_blank">
                                            <span className="lnr lnr-link"></span>
                        ...
                        <div className="grid-item minimalism" data-aos="fade-up">
                            <div className="grid-item-wrapper">
                                ...
                                <div className="grid-info">
                                    <div className="grid-link d-flex justify-content-center">
                                        <a className="img-pop" data-rel="lightcase" href="/static/img/instagram.jpg" title="Guitar">
                                            <span className="lnr lnr-move"></span>
                                        </a>
                                        <a className="ext-link" href="https://unsplash.com/" target="_blank">
                                            <span className="lnr lnr-link"></span>
                        ...
                        <div className="grid-item other" data-aos="fade-up">
                            <div className="grid-item-wrapper">
                                ...
                                <div className="grid-info">
                                    <div className="grid-link d-flex justify-content-center">
                                        <a className="img-pop" data-rel="lightcase" href="/static/img/firefox.jpg" title="Guitar">
                                            <span className="lnr lnr-move"></span>
                                        </a>
                                        <a className="ext-link" href="https://unsplash.com/" target="_blank">
                                            <span className="lnr lnr-link"></span>
                       ...
                       =
                        <div className="grid-item vintage" data-aos="fade-up">
                            <div className="grid-item-wrapper">
                                ...
                                <div className="grid-info">
                                    <div className="grid-link d-flex justify-content-center">
                                        <a className="img-pop" data-rel="lightcase" href="/static/img/photo-7.jpg" title="Guitar">
                                            <span className="lnr lnr-move"></span>
                                        </a>
                                        <a className="ext-link" href="https://unsplash.com/" target="_blank">
                                            <span className="lnr lnr-link"></span>
                        ...
                        <div className="grid-item minimalism" data-aos="fade-up">
                            <div className="grid-item-wrapper">
                                ...
                                <div className="grid-info">
                                    <div className="grid-link d-flex justify-content-center">
                                        <a className="img-pop" data-rel="lightcase" href="/static/img/disney.jpg" title="Guitar">
                                            <span className="lnr lnr-move"></span>
                                        </a>
                                        <a className="ext-link" href="https://unsplash.com/" target="_blank">
                                            <span className="lnr lnr-link"></span>
                        ...
                        <div className="grid-item vintage" data-aos="fade-up">
                            <div className="grid-item-wrapper">
                                ...
                                <div className="grid-info">
                                    <div className="grid-link d-flex justify-content-center">
                                        <a className="img-pop" data-rel="lightcase" href="/static/img/discord.jpg" title="Guitar">
                                            <span className="lnr lnr-move"></span>
                                        </a>
                                        <a className="ext-link" href="https://o.qoo-img.com/ggpht/59Y11UN03Is138F70z_I_ZN_gc8yPNNUAlh5BKlQVl82Bw07FA30sO9LWWO9Cm8PF7o?w=192" target="_blank">
                                            <span className="lnr lnr-link"></span>
                                        </a>
                                    </div>
                                    <div className="grid-title">
